...
public class _402 {
    ...
    public static class Solution2 {
        ...
        /** credit: https://discuss.leetcode.com/topic/59412/a-greedy-method-using-stack-o-n-time-and-o-n-space */
        public String removeKdigits(String num, int k, String result) {

            if(k==0){
                return num;
            }
            String str = findSol(num,k,"");

            int strNum = Integer.parseInt(str);

            return Integer.toString(strNum);
        }
        public String findSol(String num, int k, String result){
            ...
            num = num.substring(minIndex+1,len-minIndex);

            return findSol(num, k-minIndex, result);
