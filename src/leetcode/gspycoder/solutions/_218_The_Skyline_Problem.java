...
public class _218_The_Skyline_Problem {
    ...
    public static void main(String args[]){
        ...
        new Solution1().getSkyline(buildings);
    }
    public static class Solution1 {
        ...
        public List<List<Integer>> getSkyline(int[][] buildings) {
            ...
            for (BuildingPoint bp : bps){
                System.out.println("bp.x: "+bp.x+"  bp.h: "+bp.h+"   isStart: "+bp.isStart);
            }
            ...
            for (BuildingPoint bp : bps) {
                ...
                if (bp.isStart) {
                    System.out.println(" isSTART if block  bp.x: "+bp.x+"  bp.h: "+bp.h+"   isStart: "+bp.isStart);
                    ...
                    System.out.println(" NOT START if block  bp.x: "+bp.x+"  bp.h: "+bp.h+"   isStart: "+bp.isStart);
                ...
                System.out.println("currMaxH: "+currMaxH +"   prevMaxH: "+prevMaxH);
